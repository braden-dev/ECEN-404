...
# Open openMVG and openMVS directories
if not OPENMVG_BIN:
    ...
    def __init__(self):
        self.steps_data = [
            ...
            ["Global reconstruction",        # 6
             ...
             #["-i", "%matches_dir%/sfm_data.json", "-m", "%matches_dir%", "-o", "%reconstruction_dir%", "-s", "GLOBAL", "-M", "%matches_dir%/matches.e.bin", "-f", "ADJUST_FOCAL_LENGTH|ADJUST_DISTORTION"]],
