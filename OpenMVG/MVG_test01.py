...
input_eval_dir = os.path.abspath("C:\\Users\\Braden\\Desktop\\Python Web Server\\FromDatabase")
...
output_eval_dir = os.path.abspath("C:\\Users\\Braden\\Desktop\\Python Web Server\\OpenMVGProcessingData")
...
pFeatures = subprocess.Popen( [os.path.join(OPENMVG_SFM_BIN, "openMVG_main_ComputeFeatures"),  "-i", matches_dir+"/sfm_data.json", "-o", matches_dir, "-m", "SIFT", "-f" , "1", "-p", "ULTRA"] )
pFeatures.wait()
